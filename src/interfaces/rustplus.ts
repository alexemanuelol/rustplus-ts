...
export interface ClanInfo {
    ...
    logo?: Uint8Array;
    /**
     * @generated from protobuf field: int32 color = 9;
     */
    color: number;
    /**
    ...
    /**
     * @generated from protobuf field: int32 maxMemberCount = 13;
     */
...
export interface AppInfo {
    ...
    nexusZone?: string;
    /**
     * @generated from protobuf field: optional bool camerasEnabled = 16;
     */
...
export interface AppEntityPayload {
    ...
    capacity: number;
    /**
     * @generated from protobuf field: bool hasProtection = 4;
     */
...
export interface AppTeamInfo_Note {
    ...
    y: number;
    /**
     * @generated from protobuf field: optional int32 icon = 5;
     */
    icon?: number;
    /**
     * @generated from protobuf field: optional int32 colourIndex = 6;
     */
    colourIndex?: number;
    /**
 ...
 */
export enum AppTeamInfo_Note_Type {
    /**
...
export interface AppMarker {
    ...
    radius: number;
    /**
     * @generated from protobuf field: rustplus.Vector4 color1 = 8;
     */
    color1?: Vector4;
    /**
     * @generated from protobuf field: rustplus.Vector4 color2 = 9;
     */
    color2?: Vector4;
    /**
...
export interface AppMarker_SellOrder {
    ...
    /**
     * @generated from protobuf field: optional float priceMultiplier = 10;
     */
...
class ClanInfo$Type extends MessageType<ClanInfo> {
    constructor() {
        super("rustplus.ClanInfo", [
            ...
            { no: 9, name: "color", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            ...
            { no: 13, name: "maxMemberCount", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
    ...
    internalBinaryWrite(message: ClanInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* int32 color = 9; */
        if (message.color !== 0)
            writer.tag(9, WireType.Varint).int32(message.color);
        ...
        /* int64 score = 14; */
        if (message.score !== "0")
            writer.tag(14, WireType.Varint).int64(message.score);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class ClanInfo_Role$Type extends MessageType<ClanInfo_Role> {
    ...
    internalBinaryWrite(message: ClanInfo_Role, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.canAccessScoreEvents !== false)
            writer.tag(12, WireType.Varint).bool(message.canAccessScoreEvents);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class AppInfo$Type extends MessageType<AppInfo> {
    constructor() {
        super("rustplus.AppInfo", [
            ...
            { no: 11, name: "salt", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            ...
            { no: 14, name: "nexusId", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 15, name: "nexusZone", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
            { no: 16, name: "camerasEnabled", kind: "scalar", opt: true, T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    ...
    internalBinaryWrite(message: AppInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.camerasEnabled !== undefined)
            writer.tag(16, WireType.Varint).bool(message.camerasEnabled);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class AppEntityPayload$Type extends MessageType<AppEntityPayload> {
    constructor() {
        super("rustplus.AppEntityPayload", [
            ...
            { no: 4, name: "hasProtection", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 5, name: "protectionExpiry", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value?: PartialMessage<AppEntityPayload>): AppEntityPayload {
        ...
        message.items = [];
        message.capacity = 0;
        message.hasProtection = false;
        message.protectionExpiry = 0;
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int32 capacity */ 3:
                    ...
                    break;
                case /* bool hasProtection */ 4:
                    message.hasProtection = reader.bool();
                    break;
                case /* uint32 protectionExpiry */ 5:
    ...
    internalBinaryWrite(message: AppEntityPayload, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.hasProtection !== false)
...
class AppTeamInfo_Note$Type extends MessageType<AppTeamInfo_Note> {
    constructor() {
        super("rustplus.AppTeamInfo.Note", [
            ...
            { no: 3, name: "x", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
            { no: 4, name: "y", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
            { no: 5, name: "icon", kind: "scalar", opt: true, T: 5 /*ScalarType.INT32*/ },
            { no: 6, name: "colourIndex", kind: "scalar", opt: true, T: 5 /*ScalarType.INT32*/ },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AppTeamInfo_Note): AppTeamInfo_Note {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* rustplus.AppTeamInfo.Note.Type type */ 2:
                    message.type = reader.int32();
                    break;
                case /* float x */ 3:
                    message.x = reader.float();
                ...
                case /* float y */ 4:
                    message.y = reader.float();
                    break;
                case /* optional int32 icon */ 5:
                    message.icon = reader.int32();
                    break;
                case /* optional int32 colourIndex */ 6:
    ...
    internalBinaryWrite(message: AppTeamInfo_Note, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* rustplus.AppTeamInfo.Note.Type type = 2; */
        if (message.type !== 0)
        ...
        if (message.colourIndex !== undefined)
...
class AppMarker$Type extends MessageType<AppMarker> {
    constructor() {
        super("rustplus.AppMarker", [
            ...
            { no: 3, name: "x", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
            { no: 4, name: "y", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
            { no: 5, name: "steamId", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 6, name: "rotation", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
            ...
            { no: 10, name: "alpha", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
            { no: 11, name: "name", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
            { no: 12, name: "outOfStock", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* float y */ 4:
                    message.y = reader.float();
                    break;
                case /* uint64 steamId */ 5:
                    message.steamId = reader.uint64().toString();
                    break;
                case /* float rotation */ 6:
                    message.rotation = reader.float();
                    break;
                case /* float radius */ 7:
                    message.radius = reader.float();
                    break;
                case /* rustplus.Vector4 color1 */ 8:
                    message.color1 = Vector4.internalBinaryRead(reader, reader.uint32(), options, message.color1);
                    break;
                case /* rustplus.Vector4 color2 */ 9:
...
class AppMarker_SellOrder$Type extends MessageType<AppMarker_SellOrder> {
    constructor() {
        super("rustplus.AppMarker.SellOrder", [
            ...
            { no: 8, name: "itemCondition", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
            { no: 9, name: "itemConditionMax", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
            { no: 10, name: "priceMultiplier", kind: "scalar", opt: true, T: 2 /*ScalarType.FLOAT*/ }
        ]);
    }
    create(value?: PartialMessage<AppMarker_SellOrder>): AppMarker_SellOrder {
        ...
        message.itemCondition = 0;
        message.itemConditionMax = 0;
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool currencyIsBlueprint */ 7:
                    ...
                    break;
                case /* float itemCondition */ 8:
                    message.itemCondition = reader.float();
                    break;
                case /* float itemConditionMax */ 9:
                    message.itemConditionMax = reader.float();
                    break;
                case /* optional float priceMultiplier */ 10:
                    message.priceMultiplier = reader.float();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: AppMarker_SellOrder, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* optional float priceMultiplier = 10; */
        if (message.priceMultiplier !== undefined)
            writer.tag(10, WireType.Bit32).float(message.priceMultiplier);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class AppCameraRays$Type extends MessageType<AppCameraRays> {
    constructor() {
        super("rustplus.AppCameraRays", [
            ...
            { no: 6, name: "timeOfDay", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ }
        ]);
    }
    ...
    internalBinaryWrite(message: AppCameraRays, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.timeOfDay !== 0)
            writer.tag(6, WireType.Bit32).float(message.timeOfDay);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
